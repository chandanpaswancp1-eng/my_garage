...
import { UserPlus, Banknote, HandCoins, Trash2 } from 'lucide-react';
import { Staff, AdvanceSalaryRequest } from '../../../types';

export const StaffManager = () => {
  const { staff, leaves, payslips, advances, addStaff, updateLeaveStatus, addPayslip, updateAdvanceRequest } = useApp();
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Button onClick={() => setShowAddStaff(true)} className="w-full sm:w-auto"><UserPlus className="w-4 h-4 mr-2" /> Add Staff</Button>
      </div>
